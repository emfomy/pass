...
void PassHelp( const char *cmd ) {
  ...
  printf("    %-44s%-48s%.2f\n", "<pfb>", "the probabilities of forward step: choose randomly from best model",  temp.prob_forward_best);
  printf("    %-44s%-48s%.2f\n", "<pfi>", "the probabilities of forward step: local",   temp.prob_forward_improve);
  printf("    %-44s%-48s%.2f\n", "<pfr>", "the probabilities of forward step: choose randomly",  temp.prob_forward_random);
  printf("    %-44s%-48s%.2f\n", "<pbi>", "the probabilities of backward step: local",  temp.prob_backward_improve);
  printf("    %-44s%-48s%.2f\n", "<pbr>", "the probabilities of backward step: choose randomly", temp.prob_backward_random);
